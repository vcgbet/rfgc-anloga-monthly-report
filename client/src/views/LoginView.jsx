...
export const LoginView = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 flex flex-col justify-between text-slate-100 selection:bg-blue-600 selection:text-white">
      {/* Top Header Area with Real RFGC Logo */}
      <div className="pt-8 pb-3 px-4 text-center">
        <div className="inline-block p-1 bg-white rounded-full shadow-2xl border-4 border-amber-400 mb-3 animate-in zoom-in-75 duration-300">
          <img
            src={RFGC_LOGO}
        ...
        <p className="text-xs sm:text-sm text-blue-200 mt-1.5 max-w-lg mx-auto font-sans">
        ...
        <div className="bg-white text-slate-900 rounded-3xl shadow-2xl p-6 sm:p-9 border border-slate-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-[#0F1E36] hover:bg-[#1B365D] text-white font-bold text-sm rounded-xl shadow-lg transition flex items-center justify-center gap-2 group disabled:opacity-50 mt-2"
            >
